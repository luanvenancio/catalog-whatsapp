...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("grid gap-1.5 border-b px-5 py-4 pr-12", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "sticky bottom-0 z-10 mt-auto flex flex-col-reverse gap-2 border-t bg-background px-5 py-4 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    />
