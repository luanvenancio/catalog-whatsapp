...
import type { Catalog, CatalogId, CatalogSlug } from "#/features/catalog/schemas/catalogSchemas"
import type { Category, CategoryId } from "#/features/category/schemas/categorySchemas"
import type { Product, ProductId } from "#/features/product/schemas/productSchemas"
...
function mapAdminProductRow(row: typeof products.$inferSelect): AdminProductSummary {
  return {
    ...mapProductRow(row),
