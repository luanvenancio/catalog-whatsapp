...
function SettingsAdminRoute() {
  ...
  if (workspace.status === "empty")
    return (
      <main className="mx-auto max-w-3xl px-4 py-6">
        <Alert>
          <AlertTitle>Crie sua vitrine primeiro</AlertTitle>
          <AlertDescription>
            A identidade poderá ser configurada depois que a vitrine for criada.
          </AlertDescription>
        </Alert>
      </main>
    )
  return (
    <main>
      <CatalogSettingsPage catalog={workspace.catalog} />
    </main>
  )
}
